...
public abstract class Connection {
     ...
     * @param cm
     */
    public abstract void sendPacket(Packet packet, String cm);
        ...
        if (config.isDebuggerEnabled()) {
            if (debugger == null) {
                ...
                if (debuggerClass == null) {
                    try {
                        debuggerClass =
                                Class.forName("org.clever.Common.smackx.debugger.EnhancedDebugger");
                    }
                    catch (Exception ex) {
                        try {
                            debuggerClass =
                                    Class.forName("org.clever.Common.smack.debugger.LiteDebugger");
                        }
                        catch (Exception ex2) {
                            ex2.printStackTrace();
                        }
