 ...
 * together with a {@link org.clever.Common.smack.filter.PacketFilter} so that only
 ...
 *
 * @see Connection#addPacketInterceptor(PacketInterceptor, org.clever.Common.smack.filter.PacketFilter)
