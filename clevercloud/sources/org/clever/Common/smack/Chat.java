...
public class Chat {
    ...
    public void sendMessage(String text,String cm) throws XMPPException {
        Message message = new Message(participant, Message.Type.chat);
        message.setThread(threadID);
        message.setBody(text);
        chatManager.sendMessage(this, message, cm);
    }
    /**
    ...
    /**
     * Creates a {@link org.clever.Common.smack.PacketCollector} which will accumulate the Messages
