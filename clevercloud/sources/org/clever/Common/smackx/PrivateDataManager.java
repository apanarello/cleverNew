...
import org.clever.Common.smackx.packet.DefaultPrivateData;
import org.clever.Common.smackx.packet.PrivateData;
import org.clever.Common.smackx.provider.PrivateDataProvider;
...
public class PrivateDataManager {
    ...
    public static class PrivateDataIQProvider implements IQProvider {
        @Override
        public IQ parseIQ(XmlPullParser parser) throws XmlPullParserException, IOException, Exception  {
