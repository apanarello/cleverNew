...
public class MoveToLocal extends CleverCommand{
    ...
    public void exec( CommandLine commandLine ){
        ...
        try {
            ...
            if (!target.equals("")) {
                returnResponse=(String)ClusterManagerAdministrationTools.instance().execSyncAdminCommand(this, target, "HadoopNamenodeAgent", "moveToLocal", params, commandLine.hasOption("xml"));
