...
public class AddFileHadoop extends CleverCommand{
    ...
    public void exec( CommandLine commandLine ){
        ...
        try {
            ...
            if (!target.equals("")) {
                returnResponse=(String)ClusterManagerAdministrationTools.instance().execSyncAdminCommand(this, target, "HadoopNamenodeAgent", "addFile", params, commandLine.hasOption("xml"));
