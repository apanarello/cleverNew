...
public class CopyFromLocalHadoop extends CleverCommand{
    ...
    public void exec( CommandLine commandLine ){
        ...
        try {
            ...
            if (!target.equals("")) {
                returnResponse=(String)ClusterManagerAdministrationTools.instance().execSyncAdminCommand(this, target, "HadoopNamenodeAgent", "copyFromLocal", params, commandLine.hasOption("xml"));
