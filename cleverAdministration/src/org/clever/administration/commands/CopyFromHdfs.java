...
public class CopyFromHdfs extends CleverCommand{
    ...
    public void exec( CommandLine commandLine ){
        ...
        try {
            ...
            if (!target.equals("")) {
                returnResponse=(String)ClusterManagerAdministrationTools.instance().execSyncAdminCommand(this, target, "HadoopNamenodeAgent", "copyFromHdfs", params, commandLine.hasOption("xml"));
